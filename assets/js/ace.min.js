...
!(function (a) {
  ...
  (ace.vars.webkit = !!b.match(/AppleWebKit/i)),
    ...
    (ace.vars.ios_safari =
      !!b.match(/OS ([4-9])(_\d)+ like Mac OS X/i) && !b.match(/CriOS/i)),
    (ace.vars.ie =
          ...
          for (var g in c)
            if (c.hasOwnProperty(g)) {
              var h,
                i = 1 == e ? c[g] : g,
                j = a
                  .unCamelCase(i.replace(/[^A-Za-z0-9]{1,}/g, "-"))
                  .toLowerCase();
  ...
  (function (a, b) {
    (ace.demo = {
      ...
      (ace.demo.functions.enableDemoAjax = function () {
        if (a.fn.ace_ajax) {
          window.Pace &&
            (window.paceOptions = { ajax: !0, document: !0, eventLag: !1 });
          var b = {
            close_active: !0,
            ...
            content_url: function (a) {
              ...
              return b.match(/(\/ajax\/)(index\.html)?/)
                ? b.replace(
                    /(\/ajax\/)(index\.html)?/,
                    "/ajax/content/" + a.replace(/^page\//, "") + ".html"
                  )
                : b + "?" + a.replace(/\//, "=");
            },
          };
      ...
      (ace.demo.functions.handleScrollbars = function () {
        ...
        b &&
          a(".dropdown-content").ace_scroll({ reset: !1, mouseWheelLock: !0 }),
          b &&
            !ace.vars.old_ie &&
            (a(window).on("resize.reset_scroll", function () {
              a(".ace-scroll:not(.scroll-disabled)")
                .not(":hidden")
                .ace_scroll("reset");
            }),
            b &&
      ...
      (ace.demo.functions.dropdownAutoPos = function () {
        a(document).on(
          ...
          function () {
            var b = a(this).offset(),
              c = a(this.parentNode);
            parseInt(b.top + a(this).height()) + 50 >
            ace.helper.scrollTop() +
              ace.helper.winHeight() -
              c.find(".dropdown-menu").eq(0).height()
              ? c.addClass("dropup")
              : c.removeClass("dropup");
          }
        );
      }),
      (ace.demo.functions.navbarHelpers = function () {
        a('.ace-nav [class*="icon-animated-"]')
          ...
          a(document).on("click", ".dropdown-navbar .nav-tabs", function (b) {
            ...
            var c;
            b.target;
            (c = a(b.target).closest("[data-toggle=tab]")) &&
              c.length > 0 &&
              (c.tab("show"),
              b.preventDefault(),
            ...
            0 != d.length &&
              d.find(ace.vars[".icon"]).each(function () {
                var c,
                  ...
                  f = null;
                return (
                  (e = d.attr("data-icon-show"))
                    ? (f = d.attr("data-icon-hide"))
                    : (c = d.attr("class").match(/fa\-(.*)\-(up|down)/)) &&
                      ((e = "fa-" + c[1] + "-down"),
                      (f = "fa-" + c[1] + "-up")),
                  e
                    ? ("show" == b.type
      ...
      (ace.demo.functions.smallDeviceDropdowns = function () {
        function b() {
          ...
          if ("fixed" == b.css("position")) {
            ...
            0 == k.length
              ? (k = b.find(".dropdown-content.ace-scroll"))
              : (i = !0);
            ...
            b.length > 0 &&
              (b
                ...
                .each(function () {
                  ...
                  var b =
                    parseInt(a(this).attr("data-size") || 0) ||
                    a.fn.ace_scroll.defaults.size;
                  a(this)
                    .ace_scroll("update", { size: b })
                    .ace_scroll("enable")
                    .ace_scroll("reset");
                }),
              b.hasClass("user-menu")))
    ...
    if (c.length > 0) {
      ...
      a(window)
        .on("scroll.scroll_btn", function () {
          ...
          a > parseInt(b / 4) || (a > 0 && e >= b && b + a >= e - 1)
            ? d || (c.addClass("display"), (d = !0))
            : d && (c.removeClass("display"), (d = !1));
        })
  ...
  (function (a, b) {
    function c(b, c) {
        ...
        if (d.length > 0 && d.is(":visible")) {
          ...
          b.parents(".nav li").each(function () {
            ...
            if (0 == e) {
              ...
              var i = a("<li><a /></li>").insertAfter(
                d.find("> li:first-child")
              );
      ...
      (this.force_reload = !1),
        (this.loadUrl = function (a, b, c) {
          ...
          (a = a.replace(/^(\#\!)?\#/, "")),
            ...
            "function" == typeof this.settings.content_url &&
              (d = this.settings.content_url(a)),
        ...
        (this.getUrl = function (b, c, d, i, l, m, n) {
          if (!j) {
            var o,
              ...
              l = l || null;
            if (
              (g.trigger((o = a.Event("ajaxloadstart")), {
                url: b,
                hash: c,
                method: i,
                data: l,
              ...
              var p =
                "GET" == i
                  ? { url: b, cache: !this.force_reload }
                  : { url: b, method: "POST", data: l };
                ...
                a
                  ...
                  .done(function (j) {
                    ...
                    if ("function" == typeof h.settings.update_active)
                      ...
                      h.settings.update_active === !0 &&
                      c &&
                      ((o = a('a[data-url="' + c + '"]')), o.length > 0)
                    ) {
                      var q = o.closest(".nav");
                      if (q.length > 0) {
                        q.find(".active").each(function () {
                          ...
                          (a(this).hasClass("hover") ||
                            h.settings.close_active) &&
                            (b += " open"),
                            a(this).removeClass(b),
                            h.settings.close_active &&
                              a(this).find(" > .submenu").css("display", "");
                        });
                        o.closest("li")
                          .addClass("active")
                          .parents(".nav li")
                          .addClass("active open");
                        q.closest(".sidebar[data-sidebar-scroll=true]").each(
                          function () {
                            var b = a(this);
                    ...
                    "function" == typeof h.settings.update_breadcrumbs
                      ? (p = h.settings.update_breadcrumbs.call(
                          null,
                          c,
                          b,
                          o,
                      ...
                      : h.settings.update_breadcrumbs === !0 &&
                        null != o &&
                        o.length > 0 &&
                        (p = e(o)),
                      ...
                      "function" == typeof h.settings.update_title
                        ? h.settings.update_title.call(null, c, b, p, i, m)
                        : h.settings.update_title === !0 && "GET" == i && f(p),
                    ...
                    var r =
                      /\.(?:\s*)ace(?:_a|A)jax(?:\s*)\((?:\s*)(?:\'|\")loadScripts(?:\'|\")/;
      ...
      (this.startLoading = function () {
        j ||
          ((j = !0),
          this.settings.loading_overlay ||
            "static" != g.css("position") ||
            (g.css("position", "relative"), (l = !0)),
          k.remove(),
          (k = a(
            '<div class="ajax-loading-overlay"><i class="ajax-loading-icon ' +
              (this.settings.loading_icon || "") +
              '"></i> ' +
              this.settings.loading_text +
              "</div>"
          )),
          "body" == this.settings.loading_overlay
            ? a("body").append(k.addClass("ajax-overlay-body"))
            : this.settings.loading_overlay
            ? a(this.settings.loading_overlay).append(k)
            : g.append(k),
          ...
          a.ajaxPrefilter("script", function (a) {
            ...
            setTimeout(function () {
              ...
              function h(c) {
                ...
                var g =
                  "js-" + b[c].replace(/[^\w\d\-]/g, "-").replace(/\-\-/g, "-");
                d[g] !== !0
                  ? a
                      .getScript(b[c])
                      .done(function () {
      ...
      !n &&
        this.settings.default_url &&
        (window.location.hash = this.settings.default_url);
    }
    var d = {};
    (a.fn.aceAjax = a.fn.ace_ajax =
      function (d, e, f, g, h) {
        var i,
              ...
              if (k) {
                ...
                if (
                  ...
                  k &&
                    ...
                    (n = 0),
                    (l =
                      Math.abs((n = k.coords[1] - i.coords[1])) > f &&
                      Math.abs((m = k.coords[0] - i.coords[0])) <= Math.abs(n)
                        ? n > 0
                          ? "up"
                          : "down"
                        : Math.abs((m = k.coords[0] - i.coords[0])) > f &&
    ...
    function c(b, c) {
      function e() {
        (this.mobile_view = this.mobile_style < 4 && this.is_mobile_view()),
          ...
          (this.minimized =
            (!this.collapsible && this.$sidebar.hasClass(k)) ||
            (3 == this.mobile_style &&
              this.mobile_view &&
              this.$sidebar.hasClass(l))),
          (this.horizontal =
            !(this.mobile_view || this.collapsible) &&
            this.$sidebar.hasClass(n));
      }
      var f = this;
      (this.$sidebar = a(b)),
        this.$sidebar.attr("data-sidebar", "true"),
        this.$sidebar.attr("id") ||
          this.$sidebar.attr("id", "id-sidebar-" + ++d);
      var g = ace.helper.getAttrSettings(
        b,
            ...
            (d = f.attr("data-icon1")),
              ...
              "undefined" != typeof b
                ? b
                  ...
                  : f.removeClass(e).addClass(d)
                : f.toggleClass(d).toggleClass(e);
            try {
      ...
      (this.toggleMenu = function (c, d) {
        ...
        return (
          ...
          a(document).trigger("settings.ace", [
            "sidebar_collapsed",
            this.minimized,
            b,
            d,
          ...
          this.minimized
            ? this.$sidebar.trigger(a.Event("collapse.ace.sidebar"))
            : this.$sidebar.trigger(a.Event("expand.ace.sidebar")),
          !0
        );
      }),
        ...
        (this.toggleResponsive = function (b, c) {
          if (this.mobile_view && 3 == this.mobile_style) {
            ...
            if (
              (c
                ? this.$sidebar.addClass(m).removeClass(l)
                : this.$sidebar.removeClass(m).addClass(l),
              (this.minimized = !c),
              (b && "object" == typeof b) ||
                ((b = this.$sidebar.find(".sidebar-expand")),
                0 == b.length &&
                  (b = a(
              ...
              j.length > 0 &&
                ...
                (g = j.attr("data-icon2")),
                c
                  ? j.removeClass(e).addClass(g)
                  : j.removeClass(g).addClass(e));
            }
            c
              ? f.$sidebar.trigger(a.Event("mobileShow.ace.sidebar"))
              : f.$sidebar.trigger(a.Event("mobileHide.ace.sidebar")),
              a(document).triggerHandler("settings.ace", [
                "sidebar_collapsed",
                this.minimized,
              ]);
          }
      ...
      (this.show = function (b, c, d) {
        ...
        var e,
          f = a(b);
        if (
          (f.trigger((e = a.Event("show.ace.submenu"))), e.isDefaultPrevented())
        )
          return !1;
        d && (j = !0),
        ...
        (this.hide = function (b, c, d) {
          ...
          var e,
            f = a(b);
          if (
            (f.trigger((e = a.Event("hide.ace.submenu"))),
          ...
          f
            .css({ height: g, overflow: "hidden", display: "block" })
            .parent()
            .removeClass("open"),
            b.offsetHeight;
          var h = function (b, c) {
          ...
          function (b) {
            ...
            if (d && 0 != d.length) {
                ...
                return (
                  k &&
                    ...
                    a(j)
                      ...
                      .each(function () {
                        this == g ||
                          a(this.parentNode).hasClass("active") ||
                          ((i -= this.scrollHeight),
                          f.hide(this, f.settings.duration, !1));
                      }),
                  k
                    ? (f.show(g, f.settings.duration),
                      0 != i && (i += g.scrollHeight))
                    : (f.hide(g, f.settings.duration), (i -= g.scrollHeight)),
                  0 != i &&
                    ("true" != f.$sidebar.attr("data-sidebar-scroll") ||
                      f.minimized ||
                      f.$sidebar.ace_sidebar_scroll("prehide", i)),
                  !1
                );
              }
              if (
                "tap" == ace.click_event &&
                e &&
                d.get(0).parentNode.parentNode == c
              ) {
              ...
              if (ace.vars.ios_safari && "false" !== d.attr("data-link"))
                return (
                  (document.location = d.attr("href")), b.preventDefault(), !1
                );
            }
          }
        );
    ...
    a(document)
            ...
            c.hasClass("display")
              ? (f &&
                  a(document).on(e, function (b) {
                    return d.get(0) == b.target ||
                      a.contains(d.get(0), b.target)
                      ? void b.stopPropagation()
                      : (d.ace_sidebar("mobileToggle", this, !1),
                        void a(document).off(e));
                  }),
                "true" == d.attr("data-sidebar-scroll") &&
                  d.ace_sidebar_scroll("reset"))
              : f && a(document).off(e),
            !1
          );
        }
      ...
      .on(ace.click_event + ".ace.menu", ".sidebar-collapse", function (b) {
        ...
        c && (d = a(c)),
          ...
          0 != d.length &&
            (b.preventDefault(), d.ace_sidebar("toggleMenu", this));
      })
          ...
          "true" === d.attr("data-auto-hide") &&
            (d.hasClass(responsive_max_class)
              ? a(document).on(f, function (b) {
                  return d.get(0) == b.target || a.contains(d.get(0), b.target)
                    ? void b.stopPropagation()
                    : (d.ace_sidebar("toggleResponsive", e),
      ...
      if (((f = l.find(".nav-list")), (g = f.get(0)))) {
        ...
        var w,
          ...
          y = function () {
            ...
            return (
              j.sidebar_fixed && (a.top -= ace.helper.scrollTop()),
              k.innerHeight() -
                a.top -
                (j.settings.include_toggle ? 0 : h.outerHeight()) +
                1
            );
          },
          z = function () {
          ...
          A = function (b) {
            if (
              ...
              f.wrap('<div class="nav-wrap-up pos-rel" />'),
                ...
                j.settings.include_shortcuts &&
                  0 != i.length &&
                  (f.parent().prepend(i).wrapInner("<div />"),
                  (f = f.parent())),
                j.settings.include_toggle &&
                  0 != h.length &&
                  (f.append(h), f.closest(".nav-wrap").addClass("nav-wrap-t")),
                ...
                f.on(
                  ...
                  function (a) {
                    return j.is_scrolling && u.is_active()
                      ? p.trigger(a)
                      : !j.settings.lock_anyway;
                  }
                ),
                f
              ...
              if (
                ...
                "number" == typeof j.settings.smooth_scroll &&
                  ...
                  (f.css({
                    ...
                    "transition-duration":
                      (j.settings.smooth_scroll / 1e3).toFixed(2) + "s",
                  }),
                  s.css({
                    "transition-property": "top",
                    "transition-duration":
                      (j.settings.smooth_scroll / 1500).toFixed(2) + "s",
                  }),
                  p
        ...
        (this.scroll_to_active = function () {
          if (u && u.is_active())
            try {
              var a,
                b = o.vars(),
                c = l.find(".nav-list");
              b.minimized && !b.collapsible
                ? (a = c.find("> .active"))
                : ((a = f.find("> .active.hover")),
          ...
          (this.reset = function (a) {
            ...
            var c = o.vars(),
              d =
                !c.collapsible &&
                !c.horizontal &&
                (w = y()) < (x = g.clientHeight);
            (this.is_scrolling = !0),
              d &&
                (r.css({ height: x, width: 8 }),
                p.prev().css({ "max-height": w }),
                u.update({ size: w }),
                u.enable(),
                u.reset()),
              d && u.is_active()
                ? l.addClass("sidebar-scroll")
                : this.is_scrolling && this.disable();
          }),
          (this.disable = function () {
            (this.is_scrolling = !1),
              p &&
                (p.css({ height: "", "max-height": "" }),
                r.css({ height: "", width: "" }),
                p.prev().css({ "max-height": "" }),
                u.disable()),
              parseInt(g.style.top) < 0 &&
              j.settings.smooth_scroll &&
          ...
          l.on(
            ...
            function (a) {
              a.stopPropagation(),
                o.get("minimized") ||
                  (j._reset(), "shown" == a.type && j.set_hover());
            }
          ),
          A(!0);
      }
    ...
    a(document).on("settings.ace.sidebar_scroll", function (b, c, d) {
      a(".sidebar[data-sidebar-scroll=true]").each(function () {
        ...
        if ("sidebar_collapsed" == c && e(this, "fixed"))
          "true" == b.attr("data-sidebar-hover") &&
            b.ace_sidebar_hover("reset"),
            d._reset();
  ...
  (function (a, b) {
    function c(b, c) {
      ...
      function k(c) {
        ...
        if (!(H && f.find("> li > .submenu").length > 0)) {
          var I = A - (m.top - h) + v,
            J = v - I;
          if (
            (J > 0 && n > J && (I += parseInt(Math.max(n, n - J))),
            (I -= 5),
            !(90 > I))
          ) {
            var K = !1;
      ...
      d &&
        t &&
        (l.settings.sub_hover_delay = parseInt(
          Math.max(l.settings.sub_hover_delay, 2500)
        ));
      var u = a(window),
        v = a(".navbar").eq(0),
          ...
          0 != l.dirty &&
            ...
            o.find(".submenu").each(function () {
              ...
              b.css({ top: "", bottom: "", "max-height": "" }),
                b.hasClass("ace-scroll")
                  ? b.ace_scroll("disable")
                  : b.removeClass("sub-scroll"),
                f(this, "absolute")
                  ? b.addClass("can-scroll")
                  : b.removeClass("can-scroll"),
                c
                  .removeClass("pull_up")
        ...
        (this.updateStyle = function (a) {
          (sub_scroll_style = a),
            o
              ...
              .ace_scroll("update", { styleClass: a });
        }),
      ...
      e ||
        o.on("hide.ace.submenu.sidebar_hover", ".submenu", function (b) {
          if (!(1 > x)) {
            ...
            0 != c.length &&
              f(c[0], "absolute") &&
              c[0].scrollHeight - this.scrollHeight < x &&
              c.ace_scroll("disable");
          }
        }),
        e ||
          o.on(
            ...
            function (b) {
              if (!(1 > x)) {
                ...
                if (0 != c.length && f(c[0], "absolute")) {
                  ...
                  x > 14 && d - x > 4
                    ? c.ace_scroll("enable").ace_scroll("reset")
                    : c.ace_scroll("disable");
                }
              }
            }
      ...
      o.on(z, ".nav-list li, .sidebar-shortcuts", function (b) {
        if (((q = o.ace_sidebar("vars")), !q.collapsible)) {
          ...
          if (
            !(
              ...
              this.parentNode == p ||
              g ||
              (e = c.hasClass("sidebar-shortcuts"))
            )
          )
        ...
        (q = o.ace_sidebar("vars")),
          q.collapsible ||
            (a(this).hasClass("hover-show") && t && i(this).hideDelay());
      });
    }
    if (!ace.vars.very_old_ie) {
      ...
      a(window).on("resize.sidebar.ace_hover", function () {
        a(".sidebar[data-sidebar-hover=true]")
        ...
        a(document).on("settings.ace.ace_hover", function (b, c, d) {
          "sidebar_collapsed" == c
            ...
            : "navbar_fixed" == c &&
              a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover(
                "update_vars"
              );
        });
      var g = [];
    ...
    function c(b, c) {
      ...
      if (c) {
        ...
        (g = parseInt(g)),
          d.css("min-height", g),
          e
            ? (f && d.ace_scroll("disable"),
              d.css("max-height", g).addClass("overflow-scroll"))
            : (f
                ? d.ace_scroll("update", {
                    size: g,
                    mouseWheelLock: !0,
                ...
                : d.ace_scroll({ size: g, mouseWheelLock: !0, lockAnyway: !0 }),
          ...
          a(window).on("resize.widget.scroll", function () {
            ...
            (a = parseInt(a)),
              d.css("min-height", a),
              e
                ? d.css("max-height", a).addClass("overflow-scroll")
                : d.ace_scroll("update", { size: a }).ace_scroll("reset");
          });
      } else {
        d.css("min-height", "");
        ...
        h &&
          d
            ...
            .ace_scroll("reset"),
          e
            ? d.css("max-height", "").removeClass("overflow-scroll")
            : h || d.ace_scroll("disable");
      }
    }
    var d = function (b, d) {
      this.$box = a(b);
      (this.reload = function () {
        ...
        "static" == a.css("position") &&
          ((b = !0), a.addClass("position-relative")),
          a.append(
        ...
        (this.toggle = function (a, b, c, d) {
          ...
          if (
            (b ||
              ((b = e.find("> .widget-header a[data-action=collapse]").eq(0)),
              0 == b.length && (b = null)),
            b)
          ) {
            ...
            var j,
              k = null,
              l = null;
            (k = g.attr("data-icon-show"))
              ? (l = g.attr("data-icon-hide"))
              : (j = g.attr("class").match(/fa\-(.*)\-(up|down)/)) &&
                ((k = "fa-" + j[1] + "-down"), (l = "fa-" + j[1] + "-up"));
          }
        ...
        (this.fullscreen = function (a) {
          ...
          (d = b.attr("data-icon1"))
            ? (e = b.attr("data-icon2"))
            : ((d = "fa-expand"), (e = "fa-compress"));
          var f = this.$box.hasClass("fullscreen"),
            g = a !== !0 && a !== !1;
          a === !0 || (g && !f)
            ? (b.removeClass(d).addClass(e),
              this.$box.addClass("fullscreen"),
              c(this.$box, !0))
            : (a === !1 || (g && f)) &&
              (b.addClass(d).removeClass(e),
        ...
        function (b) {
          ...
          if (0 != e.length && !e.hasClass("ui-sortable-helper")) {
            ...
            if ("collapse" == g) {
              ...
              if (
                (e.trigger((h = a.Event(i + ".ace.widget"))),
              ...
              var h;
              if (
                (e.trigger((h = a.Event("close.ace.widget"))),
                h.isDefaultPrevented())
              )
                return;
              f.close();
              ...
              var h;
              if (
                (e.trigger((h = a.Event("reload.ace.widget"))),
                h.isDefaultPrevented())
              )
                return;
              f.reload();
              ...
              var h;
              if (
                (e.trigger((h = a.Event("fullscreen.ace.widget"))),
                h.isDefaultPrevented())
              )
                return;
              f.fullscreen();
  ...
  (function (a, b) {
    a("#ace-settings-btn").on(ace.click_event, function (b) {
      ...
      a("#ace-settings-highlight").on("click", function () {
        this.checked
          ? a("#sidebar .nav-list > li").addClass("highlight")
          : a("#sidebar .nav-list > li").removeClass("highlight"),
    ...
    a(document).on("settings.ace", function (b, c, d, e, f) {
      ...
      (ace.settingFunction = {
        navbar_fixed: function (b, c, d, e) {
          ...
          if (
            (a(document).trigger((f = a.Event("presettings.ace")), [
              "navbar_fixed",
              c,
              b,
              d,
          ...
          if (e !== !1 && !c) {
            var g = a("#sidebar");
            g.hasClass("sidebar-fixed") &&
              ace.settingFunction.sidebar_fixed(g.get(0), !1, d);
          }
          c
            ? a(b).addClass("navbar-fixed-top")
            : a(b).removeClass("navbar-fixed-top"),
        ...
        sidebar_fixed: function (b, c, d, e) {
          ...
          e !== !1 &&
            (c
              ? ace.settingFunction.navbar_fixed(null, !0, d)
              : ace.settingFunction.breadcrumbs_fixed(null, !1, d));
          var g = a("#menu-toggler");
          c
            ? (a(b).addClass("sidebar-fixed"), g.addClass("fixed"))
            : (a(b).removeClass("sidebar-fixed"), g.removeClass("fixed")),
            d &&
              (ace.settings.saveState(b, "class", "sidebar-fixed", c),
              0 != g.length &&
                ace.settings.saveState(g[0], "class", "fixed", c)),
        ...
        breadcrumbs_fixed: function (b, c, d, e) {
          ...
          return (
            ...
            f.isDefaultPrevented()
              ...
              : (c &&
                  e !== !1 &&
                  ace.settingFunction.sidebar_fixed(null, !0, d),
                c
                  ? a(b).addClass("breadcrumbs-fixed")
                  : a(b).removeClass("breadcrumbs-fixed"),
                d && ace.settings.saveState(b, "class", "breadcrumbs-fixed", c),
                void a(document).trigger("settings.ace", [
                  "breadcrumbs_fixed",
                  c,
                  b,
                  d,
        ...
        main_container_fixed: function (b, c, d) {
          ...
          var e;
          if (
            (a(document).trigger((e = a.Event("presettings.ace")), [
          ...
          c
            ? (a(b).addClass("container"), a(f).addClass("container"))
            : (a(b).removeClass("container"), a(f).removeClass("container")),
            d &&
              (ace.settings.saveState(b, "class", "container", c),
              0 != f.length &&
                ace.settings.saveState(f[0], "class", "container", c)),
  ...
  (function (a, b) {
    ...
    var c = function () {
      ...
      b(),
        a(".page-content-area[data-ajax-content=true]").on(
          "ajaxscriptsloaded.rtl",
          function () {
      ...
      function b(b) {
        ...
        if ("no-skin" == b) {
          ...
          a(".sidebar-shortcuts .btn").each(function () {
            ...
            a(".sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll(
              "updateStyle",
              ""
            ),
            a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover(
